        ...
        <table>
          ...
          <article class="iframe">
            ...
            <section id="iconBox">
              ...
              <button class="mbtn" v-if="myIconFlag" @click="complete_myIcon">上传</button>
            </section>
            <section id="usernameBox">
              ...
              <div class="form-group">
                <button class="mbtn" v-if="usernameFlag" @click="complete_username">完成</button>
              </div>
            </section>
            <section id="telBox">
              <div class="form-group">
              ...
              <div class="form-group">
                <button class="mbtn" v-if="telFlag" @click="complete_tel">完成</button>
              </div>
            </section>
            <section id="passwordBox">
              ...
              <div class="form-group">
                <button class="mbtn" v-if="pwdFlag" @click="complete_password">完成</button>
              </div>
            </section>
            <section id="emailBox">
              <div class="form-group">
              ...
              <div class="form-group">
                <button class="mbtn" v-if="mailFlag" @click="complete_bindEmail">完成</button>
              </div>
            </section>
            <!-- 完善个人信息弹框 -->
            <!-- <section id="addInfoBox">
              ...
              <div class="form-group">
                <button class="mbtn" v-if="addFlag" @click="complete_addInfo">完成</button>
              </div>
            </section> -->
          </article>
        </table>
...
export default {
  ...
  methods: {
    ...
    complete_myIcon(){
      ...
      $.ajax({
            ...
            if (data.code==1){
              ...
              // $(".mbtn").css("display","block");
              that.myIconFlag=true;
            }
	        },
          error: function (data) {
              alert("文件过大，只允许上传小于3M的文件");
              $(".iframe").css("display","none");
              $(".loading1").css("display","none");
              // $(".mbtn").css("display","block");
              that.myIconFlag=true;
    ...
    get_telCode(){
      let that=this;
      if ( this.wait_timer<59 && this.wait_timer>1 ){
    ...
    get_passwordCode(){
      let that=this;
      if ( this.wait_timer<59 && this.wait_timer>1 ){
        $("#password_code").removeAttr("disabled");
      }else{
        this.axios({
          method: 'post',
          url: SERVER+'traveler/sendVerifyCodeAction',
